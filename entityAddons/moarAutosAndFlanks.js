...
Class.tgs_ringer = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.flankGuard]),
            TYPE: "bullet"
        }
    }, 3),
    UPGRADES_TIER_3: [
...
Class.tgs_snowstorm = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.machineGun, { size: 0.92 }]),
            TYPE: "bullet"
        }
    }, 3),
    UPGRADES_TIER_3: [
...
Class.tgs_arachnid = {
    ...
    GUNS: weaponArray([
        ...weaponMirror({
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.pelleter, g.artillery]),
                TYPE: "bullet",
                LABEL: "Secondary"
            }
        }),
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.pounder, g.artillery]),
                TYPE: "bullet",
                LABEL: "Heavy"
            }
        }
...
Class.tgs_archer = {
    ...
    GUNS: weaponArray([
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.sniper, g.rifle]),
                TYPE: "bullet"
            }
        }
    ], 3)
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.flankGuard, g.machineGun, { size: 0.92 }]),
                TYPE: "bullet"
            }
        },
        {
...
Class.tgs_catalyst = {
    ...
    GUNS: weaponArray([
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.pounder, g.launcher]),
                TYPE: "minimissile",
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.assassin, g.flankGuard]),
                TYPE: "bullet"
            }
        },
        {
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.minigun]),
                TYPE: "bullet"
            }
        },
        {
...
Class.tgs_disposer = {
    ...
    GUNS: weaponArray([
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.sniper, g.marksman]),
                TYPE: "bullet"
            }
        }
    ], 3)
...
Class.tgs_hexidecimator = {
    PARENT: "genericTank",
    LABEL: "Hexidecimator",
    DANGER: 7,
    BODY: Class.trapGuard.BODY,
    GUNS: weaponArray([
        {
            POSITION: {
                LENGTH: 20,
    ...
    GUNS: weaponArray([
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flankGuard, g.machineGun, g.lowPower, g.pelleter, { recoil: 1.15 }]),
                TYPE: "bullet"
            }
        },
        {
...
Class.tgs_whammer = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.pounder, g.destroyer, g.flankGuard]),
            TYPE: "bullet"
        }
    }, 3)
}
Class.tgs_winger = {
    ...
    GUNS: weaponArray({
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.sniper, g.flankGuard, g.flankGuard]),
            TYPE: "bullet"
        }
    }, 6, 0.5)
}
...
Class.tgs_autoRinger = makeAuto("tgs_ringer")
Class.tgs_autoSmacker = makeAuto("tgs_smacker")
Class.tgs_autoSnowstorm = makeAuto("tgs_snowstorm")
...
if (enable_flanks) {
// names taken by other AR tanks: carbine, howitzer, ringer
    Class.sniper.UPGRADES_TIER_2.push("tgs_ringer")
        Class.assassin.UPGRADES_TIER_3.push("tgs_cateran")
        Class.hunter.UPGRADES_TIER_3.push("tgs_faucile")
        Class.rifle.UPGRADES_TIER_3.push("tgs_archer")
        Class.marksman.UPGRADES_TIER_3.push("tgs_disposer")
    Class.machineGun.UPGRADES_TIER_2.push("tgs_snowstorm")
        Class.minigun.UPGRADES_TIER_3.push("tgs_contender")
        Class.sprayer.UPGRADES_TIER_3.push("tgs_watchcat")
    Class.flankGuard.UPGRADES_TIER_2.push("tgs_ringer", "tgs_snowstorm", "tgs_smacker")
        Class.hexaTank.UPGRADES_TIER_3.push("tgs_winger", "tgs_avalanche", "tgs_deathStar", "tgs_hexidecimator")
        Class.triTrapper.UPGRADES_TIER_3.push("tgs_hexidecimator")
        Class.trapGuard.UPGRADES_TIER_3.push("tgs_hexidecimator")
    Class.pounder.UPGRADES_TIER_2.push("tgs_smacker")
        Class.destroyer.UPGRADES_TIER_3.push("tgs_whammer")
        Class.artillery.UPGRADES_TIER_3.push("tgs_arachnid")
        Class.launcher.UPGRADES_TIER_3.push("tgs_catalyst")
    //Class.tgs_autoBasic.UPGRADES_TIER_2
        Class.tgs_autoSniper.UPGRADES_TIER_3.push("tgs_autoRinger")
        Class.tgs_autoMachineGun.UPGRADES_TIER_3.push("tgs_autoSnowstorm")
        Class.tgs_autoFlankGuard.UPGRADES_TIER_3.push("tgs_autoRinger", "tgs_autoSnowstorm", "tgs_autoSmacker")
        Class.tgs_autoPounder.UPGRADES_TIER_3.push("tgs_autoSmacker")
if (enable_autos) {
        Class.tgs_ringer.UPGRADES_TIER_3.push("tgs_autoRinger")
        Class.tgs_smacker.UPGRADES_TIER_3.push("tgs_autoSmacker")
        Class.tgs_snowstorm.UPGRADES_TIER_3.push("tgs_autoSnowstorm")
}
}
